...
def page1():
    st.write('With the soaring rates of fraud and money laundering in the banking industry, Suspicious Activity Reports (SARs) are increasing in the industry '
            ...
            '  as well as periodic updates to address emerging issues and trends; and an enterprise-wide understanding of the critical role of BSA/AML reporting requirements.(1)'
...
def page2():
    ...
    st.dataframe(styled_df, use_container_width=True, height= 140) # display the filterable dataframe
...
def page3():
    ...
    st.dataframe(styled_state_df, use_container_width=True, height= 140) # display the filterable dataframe
...
# Create a dictionary to store your page functions
pages = {
    "Overview": page1,
...
# Create tabs for each page using a for loop and the pages dictionary
